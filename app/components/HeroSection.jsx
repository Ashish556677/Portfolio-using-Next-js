            ...
            <div className='grid grid-cols-1 sm:grid-cols-12'>
                <div className='col-span-7 place-self-center text-center sm:text-left'>
                    ...
                    font-semibold uppercase leading-[1] '>
                        Hello,<span className='text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-green-800'> I am a{" "}</span>
                        <br></br>
                    ...
                    <p className='text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl text-justify'>Crafting dynamic web solutions with Java 
                        expertise and as a Java Full Stack Developer 
                        demonstrates my passion for learning and expertise in Java and Spring Boot,
                         with a focus on delivering innovative solutions. Let's 
                        collaborate to bring innovative web solutions to life!
                    </p>
                    <div>
                        {/* <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-emerald-500 via-blue-500 to-green-600 hover:bg-slate-200 text-white'>Hire Me</button> */}
