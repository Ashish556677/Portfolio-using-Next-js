  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2 text-[#ADB7BE]">
        ...
        <li>Master&apos;s in Computer Application(MCA) (GPA: 10 / 8.27)</li>
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-7 mt-15 ">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-sm lg:text-base lg:text-lg text-justify w-650 h-470">
            ...
            world of technology. Thank you for considering my profile. I look forward to the opportunity to collaborate and create impactful solutions. Let&apos;s create something amazing together! 
          </p>
